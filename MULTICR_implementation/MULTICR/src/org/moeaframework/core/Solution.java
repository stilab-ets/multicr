...
public class Solution implements Serializable {
	...
	private Map<String, Object> external_attributes ; 
	/**
	...
	public Solution(int numberOfVariables, int numberOfObjectives,
		...
		external_attributes = new HashMap<String, Object>(); 
	...
	public void add_external_attributes(Map<String, Object> attributes)
	{
		external_attributes.putAll(attributes);	
	} 
	
	public Object get_external_Attribute(String key) {
