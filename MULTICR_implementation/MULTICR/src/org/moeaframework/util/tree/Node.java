...
public abstract class Node {
	...
	public String toString() {
        ...
        //System.out.println(getClass().getSimpleName()+ " lol") ; 
		for (int i = 0; i < getNumberOfArguments(); i++) {
			sb.append(' ');
			if (getArgument(i) == null) {
	...
	//to use for binary trees
	public String todot(Long id)
	{
		StringBuilder sb = new StringBuilder();
		...
		for (int i = 0; i < getNumberOfArguments(); i++) {
			   ...
			   child_id = (long) (4*id+i) ;
			   sb.append(" "+id+"->"+child_id+";") ;
			   sb.append(getArgument(i).todot(4*id+i)) ;
			}
	...
	public ArrayList<Node> getTerminals()
	{
		...
		else 
		{
			...
			{
				terminals.addAll(arg.getTerminals()) ; 
			}
		}
			return terminals ;
