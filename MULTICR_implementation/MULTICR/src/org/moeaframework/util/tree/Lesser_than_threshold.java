...
public class Lesser_than_threshold extends Threshold {
	public Lesser_than_threshold(String name, Double min, Double max, Double val,int type) {
	...
	public Node copyNode() {
		return new Lesser_than_threshold(name,min_val,max_val,val,type) ; 
	}
	...
	public boolean is_equal(Lesser_than_threshold candidate) {
