...
public class GraphViz
{
     ...
     */
    private final static String cfgProp = "../../../utils/graphviz_conf.txt";
     ...
     */
  private static String TEMP_DIR = "../../../utils/graphviz_conf.txt";
  ...
  private static String DOT = configFile.getProperty("dotFor" + osName);
    ...
    public static void main(String[] args) throws Exception {
        String dotFormat="1 [label = \"a<=5\" ]" ;
        createDotGraph(dotFormat, "C:/Users/AQ38570/Desktop/DotGraph");
 }
